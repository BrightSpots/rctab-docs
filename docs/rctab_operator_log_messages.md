...
SEVERE, "Error parsing JSON file: %s\\n%s\\n" \+ "Check file formatting and values and make sure they are correct\!\\n"
                ...
                \+ "See config\_file\_documentation.txt for more details."
...
INFO: "Launching %s version %s...", APP\_NAME, APP\_VERSION
...
INFO: "Welcome to %s version %s\!", Main.APP\_NAME, Main.APP\_VERSION
...
INFO: "See config\_file\_documentation.txt for more details."
...
INFO: "Migrated tabulator config version from %s to %s.",config.rawConfig.tabulatorVersion \!= null ? config.rawConfig.tabulatorVersion : "unknown",Main.APP\_VERSION
