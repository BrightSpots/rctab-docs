...
- Replaced `checkBoxNonIntegerWinningThreshold` and `checkBoxHareQuota` with a radio button array, and added new validation rules for those settings (fixing [#501](https://github.com/BrightSpots/rcv/issues/501))
