...
- To validate that the downloaded zip folder contains the certified version of RCTab, follow the instructions in document [**Section 23 - Trusted Build and Output Hash Verification - Windows OS**](trusted_build_and_output_hash_verification.md)
...
- Complete the instructions in [**Section 23 - Trusted Build and Output Hash Verification - Windows OS**](trusted_build_and_output_hash_verification.md) under the "Validating the hash of a trusted RCTab build" header to verify your installation.
